...
import DoctorToast from '../doctor/DoctorToast';
...
const MOBILE_NAV = [
  { key: 'home', path: '/doctor', icon: LayoutDashboard, exact: true },
  { key: 'consultations', path: '/doctor/consultations', icon: MessageSquare, badgeKey: 'pending' },
  { key: 'profile', path: '/doctor/profile', icon: User },
];
...
const DoctorShell = () => {
  ...
  return (
    <div
      className="relative min-h-screen bg-slate-50 dark:bg-[#020617] flex font-sans selection:bg-teal-500/30 overflow-hidden"
      dir={isRtl ? 'rtl' : 'ltr'}
    >
      <DoctorToast />
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute -top-[10%] -right-[10%] w-[40vw] h-[40vw] min-w-[400px] min-h-[400px] bg-teal-500/10 dark:bg-teal-500/5 rounded-full blur-[100px] animate-pulse" />
        <div className="absolute top-[40%] -left-[10%] w-[35vw] h-[35vw] min-w-[350px] min-h-[350px] bg-cyan-500/10 dark:bg-cyan-500/5 rounded-full blur-[120px]" />
      </div>
        ...
        <div className="flex justify-around items-center px-2 py-2">
          {mobileNav.map((item) => {
            ...
            return (
              ...
              >
                <div className={`relative p-2 rounded-xl ${active ? 'bg-teal-50 dark:bg-teal-500/10' : ''}`}>
